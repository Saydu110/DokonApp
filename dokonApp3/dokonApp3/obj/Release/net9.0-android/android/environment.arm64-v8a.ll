...
@aot_dso_cache = dso_local local_unnamed_addr global [1170 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x33f3ee94a169007e, ; from name: dokonApp3.dll.so
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	}, ; 220
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x34e16161efdfc0a5, ; from name: aot-dokonApp3.so
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4160e46b59efd769, ; from name: dokonApp3
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x477720148a4e53a1, ; from name: libaot-dokonApp3
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x69441c0fdadd01f3, ; from name: libaot-dokonApp3.dll.so
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x88fb3d968b8f9ee5, ; from name: aot-dokonApp3
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9e1bb7e09f87f9aa, ; from name: dokonApp3.so
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc16dc5789e10b532, ; from name: libaot-dokonApp3.so
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xca525f2be292113f, ; from name: aot-dokonApp3.dll.so
		i64 u0x69441c0fdadd01f3, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-dokonApp3.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.dokonapp3\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-dokonApp3.dll.so\00", align 1
